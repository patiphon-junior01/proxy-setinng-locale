  ...
  <!-- summernote -->
  <link rel="stylesheet" href="/web/plugins/summernote/summernote-bs4.min.css">
  <!-- bootstrap -->
  <link rel="stylesheet" href="/web/bootstrap/css/bootstrap.min.css">
  <!-- css -->
  <link rel="stylesheet" href="/web/asset/css/management_std.css">
  <!-- icon -->
  <link rel="icon" href="/web/favicon/logoweb.png">

  <!-- date thai -->
  <link rel="stylesheet" href="/web/asset/datepicker_thai/date_thai.css">